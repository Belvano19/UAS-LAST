...
@app.route('/concert')
def halaman_concert():
    return render_template('zconcert.html')

@app.route('/contact')
def halaman_contact():
    return render_template('zcontact.html')

@app.route('/hindia')
def halaman_hindia():
    return render_template('zhindia.html')
@app.route('/denny caknan')
def halaman_denny_caknan():
    return render_template('zdenny caknan.html')
@app.route('/bernadya')
def halaman_bernadya():
    return render_template('zbernadya.html')
